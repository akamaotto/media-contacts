...
import { languages, Language } from './language-data';
...
export const regions: Region[] = [
  ...
  { code: 'AND', name: 'Andean Community', category: 'organization', description: 'Regional organization of South American countries including Bolivia, Colombia, Ecuador, and Peru' },
