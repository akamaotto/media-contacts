...
interface AddBeatSheetProps {
  isOpen: boolean;
  onOpenChange: (open: boolean) => void;
  onSuccess: () => void;
}

export function AddBeatSheet({ isOpen, onOpenChange, onSuccess }: AddBeatSheetProps) {
  ...
  const onSubmit = async (data: any) => {
    ...
    try {
      ...
      if (!response.ok) {
        throw new Error(result.error || 'Failed to create beat');
      }
  ...
  return (
    <Sheet open={isOpen} onOpenChange={handleOpenChange}>
      <SheetContent className="w-full sm:max-w-md overflow-y-auto">
        <SheetHeader>
          <SheetTitle>Add New Beat</SheetTitle>
          <SheetDescription>
            Create a new beat to categorize media contacts and coverage areas.
          </SheetDescription>
        </SheetHeader>
