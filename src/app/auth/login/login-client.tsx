                  ...
                  {showPassword ? (
                    ...
                    >
                      <path
                        ...
                        strokeWidth="2"
                        d="M13.875 18.825A10.05 10.05 0 0112 19c-5.523 0-10-4.477-10-10 0-1.318.254-2.577.725-3.732M15 12a3 3 0 11-6 0 3 3 0 016 0z"
                      />
                      <path
                        strokeLinecap="round"
                        strokeLinejoin="round"
                        strokeWidth="2"
                        d="M2.458 12C3.732 7.943 7.523 5 12 5c.991 0 1.95.164 2.852.465M19.545 15.582A9.966 9.966 0 0021.542 12c-.275-.845-.676-1.654-1.18-2.402M15 12a3 3 0 11-6 0 3 3 0 016 0z"
                      />
                    </svg>
                  ) : (
                    <svg
                    ...
                    >
                      <path
                        ...
                        strokeLinejoin="round"
                        strokeWidth="2"
                        d="M3 3l18 18M15 12a3 3 0 11-6 0 3 3 0 016 0z"
                      />
                      <path
                        strokeLinecap="round"
                        strokeLinejoin="round"
                        strokeWidth="2"
                        d="M17.94 17.94A10.05 10.05 0 0112 19c-5.523 0-10-4.477-10-10 0-2.021.627-3.897 1.69-5.445M9.879 9.879A3 3 0 0112 9c1.657 0 3 1.343 3 3 0 .414-.083.808-.234 1.172"
                      />
                    </svg>
                  )}
                </button>
